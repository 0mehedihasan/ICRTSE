    ...
    >
      <div className="container flex items-center justify-between">
        <Link to="/" className="flex items-center space-x-2">
          ...
          <span className="text-xl font-bold text-primary-700">ICRCS 2025</span>
        </Link>
        ...
        <div className="hidden lg:flex lg:items-center lg:space-x-8">
          {navLinks.map((link) => (
            <div key={link.name} className="relative group">
              {link.children ? (
                <div>
                  <button className="flex items-center text-sm font-medium text-secondary-700 hover:text-primary-600">
                    {link.name}
